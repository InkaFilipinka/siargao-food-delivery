...
<div style="max-width:375px;margin:0 auto;background:var(--tg-surface);min-height:100vh;">
  ...
  <div style="height:192px;background:linear-gradient(135deg,#6B7B6B,#5A6B5A);position:relative;overflow:hidden;">
    <img src="https://images.unsplash.com/photo-1552566626-52f8b828add9?w=750&h=400&fit=crop" alt="" style="width:100%;height:100%;object-fit:cover;opacity:0.9;">
